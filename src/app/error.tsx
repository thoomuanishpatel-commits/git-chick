...
export default function ErrorBoundary({
  ...
  useEffect(() => {
    console.error('[ResQ-AI Boundary Caught]:', error);
  }, [error]);

  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 text-white font-mono select-none">
      <div className="max-w-md w-full bg-zinc-900 border border-white/10 p-6 rounded-2xl text-center space-y-4 shadow-2xl">
        ...
        <h2 className="text-sm font-bold tracking-wider uppercase text-cyan-400">
          ResQ-AI Tactical Interface Resumed
        </h2>
        <p className="text-xs text-zinc-400 leading-relaxed">
          The operations dashboard encountered a transient display event and recovered.
        </p>
        <button
          type="button"
          onClick={() => {
